...
return [
     ...
     */
    'middleware' => ['web', 'auth', 'auth.session', AuthorizeRouteName::class],
    ...
    'aclRules' => [
        ...
        1 => [
            ['disk' => 'public', 'path' => 'folder1/nested1/acl_folder_1', 'access' => 1],
            ['disk' => 'public', 'path' => 'folder1/nested1/deep_nested_folder_1', 'access' => 1],
