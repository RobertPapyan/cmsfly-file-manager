...
const IconMap = [
  ...
  {
    icon: FileDigitIcon,
    extensions: ["bin", "dat", "hex", "iso", "img", "raw", "dll", "so"],
  },
  {
    icon: FileTextIcon,
    extensions: ["txt", "md", "doc", "docx", "rtf", "odt", "log"],
  },
  {
  ...
  {
    icon: FileCogIcon,
    extensions: ["env", "ini", "cfg", "conf", "yml", "yaml"],
  },
  ...
  {
    icon: MusicIcon,
    extensions: ["mp3", "wav", "aac", "flac", "ogg", "m4a", "wma", "opus"],
  },
];
