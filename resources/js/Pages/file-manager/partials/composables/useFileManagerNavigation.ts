import { Directory, TreeNode } from "../types";
import { tree,currentFolder, openFolder, findFolderInTree } from "./useFileManagerCore";
...
watch(()=>tree.value.basename,(newVal)=>{
